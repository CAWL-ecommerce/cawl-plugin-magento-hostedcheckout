...
class PaymentFromApplicableCountriesTest extends TestCase
{
     ...
     * @magentoConfigFixture current_store payment/worldline_hosted_checkout/allowspecific 1
     * @magentoConfigFixture current_store payment/worldline_hosted_checkout/specificcountry AF
