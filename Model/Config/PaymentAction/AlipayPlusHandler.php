...
class AlipayPlusHandler implements PaymentActionReplaceHandlerInterface
{
    private const ALIPAY_PLUS_PAYMENT_ACTION = 'authorize_capture';
    ...
    public function getPaymentAction(OrderPaymentInterface $payment): ?string
    {
        ...
        return PaymentProductsDetailsInterface::ALIPAY_PLUS_PRODUCT_ID === $paymentProductId
            ? self::ALIPAY_PLUS_PAYMENT_ACTION : null;
    }
}
